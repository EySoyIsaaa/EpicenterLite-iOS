...
## Consentimiento AdMob

- `getAdConsentState()`
- `showAdPrivacyOptions()`

El plugin local conserva únicamente el puente de consentimiento y opciones de
privacidad. Los intersticiales se gestionan mediante Capacitor Community AdMob.
