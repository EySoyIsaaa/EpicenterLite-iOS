...
interface HomeSettingsViewProps {
  ...
  onOpenAdPrivacyOptions: () => void;
  onOpenTutorial: () => void;
  onGetFullVersion: () => void;
}
      ...
      <div className="flex-1 overflow-y-auto px-6 py-4 space-y-6 home-scroll-with-player">
        ...
        <div className="bg-zinc-900/50 rounded-2xl p-4">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-full bg-[rgba(255,16,42,0.12)] border border-[rgba(255,16,42,0.25)] flex items-center justify-center">
              <Sparkles className="w-5 h-5 text-[var(--ep-red)]" />
            </div>
            <div>
              <h3 className="font-semibold">EpicenterDSP Full</h3>
              <p className="text-xs text-zinc-500">{t("lite.fullDescription")}</p>
            </div>
          </div>
          <Button onClick={onGetFullVersion} className="w-full rounded-full btn-brand">
            {t("lite.getFull")}
          </Button>
        </div>
        ...
        <div className="bg-zinc-900/50 rounded-2xl p-4">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-semibold">{t("lite.privacy.title")}</h3>
              <p className="text-xs text-zinc-500">
                {t("lite.privacy.description")}
              </p>
            </div>
          </div>
          <Button
          ...
          >
            <span>{t("lite.privacy.button")}</span>
        ...
        <div className="bg-zinc-900/50 rounded-2xl p-4">
          ...
          <div className="grid gap-2">
            <Button
              ...
              className="tutorial-next-button w-full justify-between rounded-xl"
            >
              <span className="flex items-center gap-2">
                <Headphones className="h-4 w-4" />
                {t("settings.tutorialCta")}
              </span>
